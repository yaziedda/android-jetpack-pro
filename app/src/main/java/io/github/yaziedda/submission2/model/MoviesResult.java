...
public class MoviesResult implements Serializable {
    ...
    public static ResponseMovies dummyResponse(){
        ResponseMovies responseMovies = new ResponseMovies();
        responseMovies.setPage(1);
        responseMovies.setTotalPages(5);
        responseMovies.setTotalResults(10);
        responseMovies.setResults(populate());
        return responseMovies;

    }

    public static List<MoviesResult> populate(){
        ...
        for (int i=0; i < title.length; i++){
            ...
            movies.setReleaseDate(release[i]);
