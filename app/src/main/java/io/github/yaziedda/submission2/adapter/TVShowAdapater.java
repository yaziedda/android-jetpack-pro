...
public class TVShowAdapater extends RecyclerView.Adapter<TVShowAdapater.ViewHolder> {

    List<TVShow> list = new ArrayList<>();
    boolean horizontal = false;

    public interface OnItemClickListener {
        void onItemClick(TVShow model);
    }

    private final OnItemClickListener listener;

    public TVShowAdapater(List<TVShow> list, OnItemClickListener listener, boolean horizontal) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final TVShow model = list.get(position);
